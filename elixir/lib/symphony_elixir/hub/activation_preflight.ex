defmodule SymphonyElixir.Hub.ActivationPreflight do
  ...
  defp detected_ownership(project, probe) do
    ...
    |> add_probe_ownership(project, probe, :dashboard_port_owners, "dashboard_port_owner")
    |> add_probe_ownership(project, probe, :api_port_owners, "api_port_owner")
  ...
  defp unknown_probe_results(probe) do
    ...
    |> add_unknown(list_unknown?(probe, :dashboard_port_owners), "dashboard_port_owner", "dashboard_port_owner_unknown", probe)
    |> add_unknown(list_unknown?(probe, :api_port_owners), "api_port_owner", "api_port_owner_unknown", probe)
